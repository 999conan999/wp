...
<head>
 ...
 <script type="application/ld+json">
    {"@context":"https://schema.org","@type":"ItemList","itemListElement":[{"@type":"ListItem","item":{"@type":"Thing","url":"<?php echo $home_url; ?>","@id":"<?php echo $home_url; ?>#1","name":"Trang chủ"},"position":1},{"@type":"ListItem","item":{"@type":"Thing","url":"<?php echo $post_infor->phu->category_link; ?>","@id":"<?php echo $post_infor->phu->category_link; ?>#2","name":"<?php echo $post_infor->phu->category_name; ?>"},"position":2},{"@type":"ListItem","item":{"@type":"Thing","url":"<?php echo  $current_url;?>","@id":"<?php echo  $current_url;?>#3","name":"<?php echo  $post_infor->contents->title;?>"},"position":3}]} 
</script>
...
<?php }?>
    ...
    <script defer="defer" src="<?php echo $home_url; ?>/wp-content/themes/danhdev_1/templates/single/static/js/main.2fe8338c.js"></script>
    <link href="<?php echo $home_url; ?>/wp-content/themes/danhdev_1/templates/single/static/css/main.4419b4b8.css" rel="stylesheet">
</head>
